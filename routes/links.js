...
router.get('/', function (req, res, next) {
    ...
    res.render('links', {"user": session.user, "links": req.app.get('linkrepo').getAllLinks()})
    //res.send(req.app.get('linkrepo').getAllLinks());
});
...
router.put('/', function (req, res, next) {
    ...
    res.end('{"text": "thanks for the data"}');
    //res.end();
});
...
router.delete('/:id', function (req, res, next) {
    ...
    res.end(); //send('{"text": "removed link"}');
});
